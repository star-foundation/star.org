...
npm test                 # full test suite (94 tests, including 3 rounds of the oversell concurrency test)
...
```bash
npm test                # 94 tests, roughly 1-2 minutes (includes 3 rounds of the oversell concurrency test)
